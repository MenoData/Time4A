...
Time4A closes this big gap **supporting actually 57 languages** and has more features than any other date and time
...
```groovy
dependencies {
    compile group: 'net.time4j', name: 'time4j-android', version: '3.11-2015g'
}
```
