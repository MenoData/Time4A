...
Time4A closes this big gap **supporting actually 46 languages** and has more features than any other date and time
...
```groovy
dependencies {
    compile group: 'net.time4j', name: 'time4j-android', version: '3.9-2015f'
}
```
