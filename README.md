...
Time4A closes this big gap **supporting actually 70 languages** and has more features than any other date and time
...
```groovy
dependencies {
    compile group: 'net.time4j', name: 'time4j-android', version: '3.14-2015g'
}
```
